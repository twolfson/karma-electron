...
var $inject = [
  ...
  'processKillTimeout',
  'args', 'config.basePath', 'config.urlRoot'];
function ElectronBrowser(
    baseLauncherDecorator,
    captureTimeoutLauncherDecorator,
    retryLauncherDecorator,
    processLauncherDecorator,
    processKillTimeout,
    args, karmaBasePath, karmaUrlRoot) {
  // Apply browser decorations to ourself
  // console.log('aaaa', baseBrowserDecorator + '');
  ...
  console.log('aaa', processLauncherDecorator(this, processKillTimeout));
