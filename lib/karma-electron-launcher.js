...
function ElectronBrowser(baseBrowserDecorator, args, karmaBasePath, karmaUrlRoot) {
  ...
  this._getOptions = function (url) {
    ...
    if (extendedOptions) {
      ...
      retArr = retArr.concat(['--extended-options']);
    }
    console.log('arguments', retArr);
    return retArr;
  };

  var __onStdout = this._onStdout;
  this._onStdout = function (data) {
    console.log('stdout', data.toString('utf8'));
    return __onStdout.apply(this, arguments);
  }
  var __onStderr = this._onStderr;
  this._onStderr = function (data) {
    console.log('stderr', data.toString('utf8'));
    return __onStderr.apply(this, arguments);
  }

  var __onProcessExit = this._onProcessExit;
  this._onProcessExit = function () {
    console.log('exitttt', arguments);
    return __onProcessExit.apply(this, arguments);
  }
}
