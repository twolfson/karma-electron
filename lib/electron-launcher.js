...
async.parallel([
  ...
  // throw new Error(JSON.stringify(browserWindowOptions))
  ...
  // throw new Error(decodeURIComponent(program.encodedUrl))
  browserWindow.loadURL('about:blank', loadURLOptions);
