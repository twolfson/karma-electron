...
program.option('--disable-web-security', 'Boolean to make the window visible', false);
...
app.on('ready', function handleReady () {
  ...
  browserWindow.loadURL(program.url, {
    ...
    // DEV: Default wouldcd be "Chrome 47.0.2526 (Linux 0.0.0)"
